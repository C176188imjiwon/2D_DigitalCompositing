...
***
## Gamma
- 디스플레이에 입력되는 신호의 밝기와 화면 상에 나타나는 영상의 휘도 간의 상관 관계를 결정하는 수치. 곡선의 그래프 형태로 되어있다.
...
<p align="center"><img src="https://user-images.githubusercontent.com/112764860/192719897-261c58a3-2268-4480-9651-08fe335fd43c.png" width="60%" height="60%"/></p>
 <p align="center"><그림 1> sRGB 이미지가 CRT 모니터로 통해 보여지는 과정 </p> 
...
<p align="center"><img src="https://user-images.githubusercontent.com/112764860/192717736-3ad5b8bf-353a-4874-85eb-16961bf02c57.png" width="50%" height="50%"/></p>
 ...
 - 삼각형의 각 꼭짓점의 정점은 고유 색상으로 표현된 RGB(빨강,초록,파랑) 의 값이다.
  
#### [Gamut]
* 색재현율, 색역이라고도 불리며, 원본이 표현하는 색을 화면에서 어느 정도까지 표현 가능한지를 수치화한 것으로, 디스플레이에서 표현 가능한 색상의 범위를 의미한다.
* 일반적으로 CIE 색좌표계에서 표현하는 sRGB, Adobe RGB, DCI-P3와 같은 색상 규격을 기준으로 얼마나 색 표현이 가능한지를 백분율로 표기한 것이다.
***
## Visual Languages for Stortytelling
* Value (명도) 
  - 색의 밝고 어두운 정도.   
  - 시각적으로 가장 중요하다.   
  - 가장 밝은것과 가장 어두운것을 이용해서 감독이 유도한 곳으로 관객들의시선을 유도할 수 있다   
  - 색을 사용할 수 없다고해서 이미지를 만들수 없는건 아니다. 흑백으로도 충분히 표현이 가능하다.  
* Contrast (대비) 
  - 두 가지 이상의 것이 서로의 영향을 받아 각 특성이 더욱 돋보이게 하는 정도.  
  - 명도대비로 인해서 시선을 유도할 수 있고 어딘가로 시선을 잡아끌 수도 있다.   
  - 명도의 차가 없다면, 대비가 없는것이고 관객들도 어딜 봐야 할 지 모를 수도 있다.  
  - 명도차이로 사건을 두분류로 나누어서 밸런스조절이 가능하다.
* Sharpness (선명도)  
  - 물체의 선명하고 흐릿한 정도. 선명함의 대비로 관객에게 어디로 시선을 유도할 것인지 표현할 수 있다.  
  - 질감의 차이로 대비감을 줄 수 있다.
