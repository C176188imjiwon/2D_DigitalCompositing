...
- aerial diffusion은 배경에 먼지, 연기, 가루, 안개 등을 넣어 빛을 분산시켜 화면 자체가 뿌옇게 보이는 효과를 준다. 밀도와 선명함이 사라지고 뭉트그러진 색의 잔상만 보이도록 한다. 오싹하거나 몽환적인 분위기를 연출할 때 많이 사용된다. 공간감을 내는게 가장좋은게 fog. 그러나 많이 과하면 답답하고 공간이 막혀보일 수 있다.
